...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this2.createBorderedImage = function () {
      var _this = _this2;
      var _state = _this2.state;
      var _canvas = _this2.canvas.current;
      var fileList = _this2.fileInput.current.files;
      var reader = new FileReader();

      if (_this2.state.canvasCreated) _this2.canvas.outerHTML = '';
      if (typeof fileList[0] == 'undefined') return;
    ...
    _this2.handleChange = function (e, key) {
      _this2.setState(_defineProperty({}, key, e.target.value), _this2.createBorderedImage);
    };
    ...
    _this2.fileInput = _react2.default.createRef();
    _this2.canvas = _react2.default.createRef();
    return _this2;
  }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', {
          onChange: function onChange(e) {
            return _this3.handleChange(e, 'width');
          },
          type: 'text',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', {
            ...
            name: 'color',
            onChange: function onChange(e) {
              return _this3.handleChange(e, 'color');
            },
            type: 'color',
        ...
        this.state.canvasCreated && _react2.default.createElement(
          'a',
          { href: this.state.blob, download: 'bordered-image.jpg' },
          'Download image'
        ),
        _react2.default.createElement('canvas', { id: 'canvas', width: '0', height: '0', ref: this.canvas })
      );
    }
  }]);
